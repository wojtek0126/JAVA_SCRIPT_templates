// 3 ways: https://www.freecodecamp.org/news/three-ways-to-find-the-longest-word-in-a-string-in-javascript-a2fb04c9757c/
...
// this: const findLongest = s => Math.max(...s.split(" ").map(x => x.length));